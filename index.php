            ...
            <div class="container text-center hero-text font-white">
                ...
                <div class="steps">
                    <div class="step-item step1">
                        ...
                        <h4><span style="color:white;">1. </span>Choose Organic Restaurant</h4>
                    </div>
                    ...
                    <div class="step-item step2">
                        ...
                        <h4><span style="color:white;">2. </span>Order Diet-Friendly Fare</h4>
                    </div>
    ...
    <section class="popular">
        <div class="container">
            <div class="title text-xs-center m-b-30">
                <h2>Popular Organic Dishes of the Month</h2>
                <p class="lead">The simplest method to order healthy, organic food is by selecting from these top six dishes</p>
            </div>
            <div class="row">
